...
public class AdvancedWebView extends WebView {
    ...
    public interface Listener {
        ...
        boolean onExternalPageRequest(WebView view,String url);
    ...
    private static final String[] ALTERNATIVE_BROWSERS = new String[] { "org.mozilla.firefox", "com.android.chrome", "com.opera.browser", "org.mozilla.firefox_beta", "com.chrome.beta", "com.opera.browser.beta" };
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(final WebView view, final String url) {
                if (mListener != null) {
                    ...
                    return mListener.onExternalPageRequest(view,url);
                }
